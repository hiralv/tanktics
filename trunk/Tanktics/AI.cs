...
namespace Tanktics
{
    ...
    class AI
    {
        ...
        static public int[,] values = new int[25, 25] {  
                            ...
                            {2,	2,	3,	4,	6,	11,	16,	21,	26,	31,	36,	41,	46,	41,	36,	31,	26,	21,	16,	11,	 6,	 4,	 3,	 2,	2},
                            ...
                            {10,11,	10,	10,	11,	12,	16,	21,	26,	31,	36,	41,	45,	45,	36,	31,	26,	21,	17,	12,	11, 10, 10, 11, 10},
                            {15,16,	15,	15,	15,	16,	17,	21,	26,	31,	36,	40,	40,	41,	36,	31,	26,	22,	17,	16,	16,	15, 15, 16, 15},
                            {20,21,	20,	20,	20,	21,	21,	22,	26,	36,	41,	45,	50,	40,	35,	31,	27,	22,	21, 21,	21,	20, 20, 21, 20},
                            ...
                            {25,26,	25,	25,	26,	26,	26,	26,	27,	31,	36,	46,	51,	51,	0,	31,	27,	26,	26, 26, 26, 25, 25, 26, 25},
                            {20,21,	20,	20,	21,	21,	21,	22,	26,	31,	36,	41,	50,	46,	41,	31,	26,	22,	21, 21, 21, 20, 20, 21, 20},
                            {15,16,	15,	15,	16,	16,	17,	21,	26,	31,	35,	40,	51,	41,	35,	31,	26,	21,	17, 16, 16, 15, 15, 16, 15},
                            ...
                            {4,	4,	4,	4,	5,	10,	15,	20,	25,	30,	-4,	50,	55,	50,	-4,	30,	25,	20,	15,	10,	5,	4,	4,	4,	4},
                            {3,	3,	3,	4,	5,	10,	15,	20,	25,	30,	-4,	-4,	50,	-4,	-4,	30,	25,	20,	15,	10,	5,	4,	3,	3,	3},
                            {2,	2,	3,	4,	5,	11,	16,	21,	26,	31,	36,	41,	46,	41,	36,	31,	26,	21,	16,	11,	6,	4,	3,	2,	2},
                            {1,	2,	3,	4,	5,	10,	15,	20,	25,	30,	35,	40,	45,	40,	35,	30,	25,	20,	15,	10,	5,	4,	3,	2,	1}};
