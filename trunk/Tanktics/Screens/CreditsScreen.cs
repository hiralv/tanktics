...
namespace Tanktics
{
    ...
    class CreditsScreen : GameScreen
    {
        ...
        Texture2D[] infantry = new Texture2D[4];
        ...
        public override void LoadContent()
        {
            ...
            infantry[0] = content.Load<Texture2D>("Infintry");
            infantry[1] = content.Load<Texture2D>("Infintry2");
            infantry[2] = content.Load<Texture2D>("Infintry3");
                                                       ...
                                                       bool coveredByOtherScreen)
        {
            ...
            if (sprite2.Position.X <= -85)
            {
                if (counter < nameArray.Length-1)
                {
                    ...
                    if (counter%4 == 1)
                    {
                        sprite2.Texture = infantry[0];
                        sprite.Texture = infantry[0];
                    }
                    if (counter % 4 == 2)
                    {
                        sprite2.Texture = infantry[1];
                        sprite.Texture = infantry[1];
                    }
                    if (counter % 4 == 3)
                    {
                        sprite2.Texture = infantry[2];
                        sprite.Texture = infantry[2];
                    }
                    if (counter % 4 == 0)
                    {
                        sprite2.Texture = infantry[3];
