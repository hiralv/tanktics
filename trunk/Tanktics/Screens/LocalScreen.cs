...
// LocalScreen.cs
//
// Display the LocalScreen menu. --Chris Wykel
//-----------------------------------------------------------------------------
#endregion
...
namespace Tanktics
{
    ...
    class LocalScreen : GameScreen
    {
        ...
        public override void LoadContent()
        {
            ...
            //load stuff
            MenuImage = content.Load<Texture2D>("Main Menu/individual copy");
