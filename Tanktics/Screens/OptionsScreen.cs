...
namespace Tanktics
{
    ...
    class OptionsScreen : GameScreen
    {
        ...
        public override void LoadContent()
        {
            ...
            //load stuff
            MenuImage = content.Load<Texture2D>("Main Menu/controls copy");
        ...
        public override void HandleInput(InputState input)
        {
            ...
            else if (!input.IsKeyDownLeft() && !input.IsKeyDownRight() && !input.IsKeyDownDown())
            {
                ...
                if (input.MenuSelect)
                {
                    gameAudio.PlaySound("Menu Sound");
                    ExitScreen();
                    ScreenManager.AddScreen(new ControlScreen());
                }
            ...
            else if (input.IsKeyDownLeft())
            {
                ...
                if (input.MenuSelect)
                {
                    gameAudio.PlaySound("Menu Sound");
                    ExitScreen();
                    ScreenManager.AddScreen(new VideoScreen());
                }
            ...
            else if (input.IsKeyDownRight())
            {
                ...
                if (input.MenuSelect)
                {
                    gameAudio.PlaySound("Menu Sound");
                    ExitScreen();
                    ScreenManager.AddScreen(new AudioScreen());
                }
